...
static bool LoadObj(std::string filename, tinyobj::attrib_t &attrib, std::vector<tinyobj::shape_t> &shapes, std::vector<tinyobj::material_t> &materials)
{
                        ...
                        bool triangulate = true)
{
       ...
       t.stop();
       std::cout << "Parsing time: " << t.elapsed_time_milliseconds() << " [msecs]\n";
